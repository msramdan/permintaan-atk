...
<body class='pace-top'>
	...
	<script src="<?= base_url() ?>assets/assets/js/vendor.min.js" type="6b76989f612f42d3909ff0b2-text/javascript"></script>
	<script src="<?= base_url() ?>assets/assets/js/app.min.js" type="6b76989f612f42d3909ff0b2-text/javascript"></script>
	<script src="<?= base_url() ?>assets/assets/js/theme/transparent.min.js" type="6b76989f612f42d3909ff0b2-text/javascript"></script>
