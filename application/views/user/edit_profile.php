					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
						<table class="table table-profile align-middle">
							...
							<tbody>
								...
								<tr class="highlight">
									<td class="field"'>Alamat User <?php echo form_error('alamat_user') ?></td><td>
			                        ...
			                        <td>
			                            <a href="#modal-dialog" data-bs-toggle="modal">
											<?php if ($this->fungsi->user_login()->level_id == '2') { ?>
												<img style="width: 150px;height: 150px;border-radius: 50%;" src="<?= base_url() ?>assets/assets/img/guru/<?= photo_guru($this->session->userdata('userid')) ?>" alt="" />
											<?php } else if ($this->fungsi->user_login()->level_id == '3') { ?>
												<img style="width: 150px;height: 150px;border-radius: 50%;" src="<?= base_url() ?>assets/assets/img/pegawai/<?= photo_pegawai($this->session->userdata('userid')) ?>" alt="" />
											<?php } else if ($this->fungsi->user_login()->level_id == '4') { ?>
												<img style="width: 150px;height: 150px;border-radius: 50%;" src="<?= base_url() ?>assets/assets/img/siswa/<?= photo_siswa($this->session->userdata('userid')) ?>" alt="" />
											<?php } ?>
										</a>
